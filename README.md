...
2. Uses C++17 to meet the [requirements of ceres-solver](http://ceres-solver.org/installation.html) and generally modernise the repo
3. Added script to install dependencies and ceres-solver
---
# VINS-Mono
...
> **Update**: In this fork, works with ceres-solver 2.2.0. (only 2.2.0 is tested). To install ceres-solver, run / follow the commands in [install-deps.sh](./install-deps.sh)
